...
change =modern= to =vim= and, head to the [[#evil][Evil]] section below.
...
note, however, that you won't be able to use the =:= commands.
...
experience. If you don't like using paredit, edit the value below to
be =nil= instead of =1=.
